...
// Categories: keep separate lookups by slug for column composition
try {
...
// Buckets: shoes, clothing, accessories, outlet
...
foreach ($navAllCategories as $c) {
    $s = strtolower($c['slug']);
    if (in_array($s, $_shoeSlugs, true))          $navShoeCats[]      = $c;
    elseif (in_array($s, $_clothingSlugs, true))  $navClothingCats[]  = $c;
    elseif (in_array($s, $_accessorySlugs, true)) $navAccessoryCats[] = $c;
}

// Shoe types drive the "Shoes" column when categories aren't organized that way
try {
    $navShoeTypes = $db->query("SELECT slug, name_mn, name FROM shoe_types WHERE is_active = 1 ORDER BY sort_order")->fetchAll();
} catch (Throwable) { $navShoeTypes = []; }

// Run types for a "Run purpose" quick link column
try {
 ...
 */
function renderProductCard(array $prod, int $i): void {
...
<head>
    ...
    <link rel="preload"
        href="https://fonts.googleapis.com/css2?family=Cabin:wght@400;500;600;700&family=Caveat:wght@400;500;600;700&family=Bebas+Neue&family=Caprasimo&display=swap"
...
<body class="rbt-header-sticky">
                                ...
                                <div class="rbt-fancy-text">
                                    ...
                                    <div class="rbt-text-swiper-container rbt-arrow-vertical">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">christmas, thanksgiving, trees, decor, ornaments
                                                <a class="rbt-fancy-link ml--4" href="shop.html">Know more</a>
                                            </div>
                                    ...
                                    <ul class="rbt-quick-access d-none d-lg-flex">
                                        <li class="rbt-access-box">
                                            <div class="header-info">
                                                <a href="find-store.html" class="rbt-access-link">Store Location</a>
                                            </div>
                                            <div class="header-info">
                                            ...
                                            <div class="header-info">
                                                <ul
                                                    class="rbt-dropdown-menu rbt-dropdown-menu-elastic switcher-language">
                                                    <li class="has-child-menu">
                                                        <a href="#">
                                                            <img class="left-image" src="assets/images/icons/eng.webp"
                                                                alt="Language Images">
                                                            <span class="menu-item">Eniglish</span>
                                                            <i class="right-icon fa-regular fa-chevron-down"></i>
                                                        </a>
                                                        <ul class="sub-menu ">
                                                            <li>
                                                                <a href="#" class="active">
                                                                    <img class="left-image"
                                                                        src="assets/images/icons/eng.webp"
                                                                        alt="Language Images">
                                                                    <span class="menu-item">Eniglish</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    <img class="left-image"
                                                                        src="assets/images/icons/den.webp"
                                                                        alt="Language Images">
                                                                    <span class="menu-item">Danish</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    <img class="left-image"
                                                                        src="assets/images/icons/italic.webp"
                                                                        alt="Language Images">
                                                                    <span class="menu-item">Italic</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                ...
                <div class="rbt-header-sec align-items-center @@flexDirection">
                    ...
                    <div class="rbt-main-navigation d-none d-xl-block">
                        <nav class="rbt-mainmenu-nav">
                            <?php require __DIR__ . "/includes/nav-menu.php"; ?>
                        </nav>
                    </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="rbt-fancy-item fancy-menu-text fancy-menu-center">
                                                    <p class="rbt-fancy-text rbt-text-color-white">Top products. Better
                                                        prices
                                                        -under $100.
                                                        <a class="rbt-text-color-white" href="shop.html">Shop Now</a>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
    ...
    <div class="rbt-component-area rbt-brands-area rbt-section-gap rbt-bg-color-white">
        <div class="container">
            ...
            <div class="row row--12 mt_dec--24">
                <?php $_shops = getShops(); if (empty($_shops)): ?>
                    ...
                    <div class="rbt-welcome-banner-area rbt-content-trs-portion">
                        <div class="rbt-welcome-banner-content">
                            <div class="rbt-welcome-banner-top position-relative overflow-hidden rbt-rounded--12">
                                <img src="assets/images/banner-img/welcome-banner-img-01.webp"
                                    alt="Ecommerce Banner Image">
                            </div>
                            <div class="rbt-welcome-banner-bottom pt--32">
                                <h2 class="text-center mb--12">Don’t miss out Offers</h2>
                                <p class="text-center b1 mb--32">Be the first one to get the new product at early bird
                                    prices.</p>
                                <form id="rbtSubscribe-form" action="#" class="form-newsletter">
                                    <div class="rbt-input-field-grp">
                                        <input class="rbt-input-field" type="email" placeholder="Your Email Address *">
                                    </div>
                                ...
                                <div class="text-center">
                                    <a href="#" data-bs-dismiss="modal"
                                        class="rbt-btn rbt-btn-naked radius-round-6 d-block">Not interested</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row rbt-compare-products">
                        <div class="col-10 col-md-3 col-lg-3">
                            <div class="rbt-card rbt-comparison-prd-box">
                                ...
                                <div class="rbt-comparison-prd-img">
                                    <a href="product-single-default.html">
                                        <img src="assets/images/product-img/electronics/electronics-bg-trans-05-a-1.webp"
                                            alt="Product Image">
                                    </a>
                                </div>
                        ...
                        <div class="col-10 col-md-3 col-lg-3">
                            <div class="rbt-card rbt-comparison-prd-box">
                                ...
                                <div class="rbt-comparison-prd-img">
                                    <a href="product-single-default.html">
                                        <img src="assets/images/product-img/electronics/electronics-bg-trans-06-a-1.webp"
                                            alt="Product Image">
                                    </a>
                                </div>
                                <h2 class="rbt-product-title h6">
                        ...
                        <div class="col-10 col-md-3 col-lg-3">
                            <div class="rbt-card rbt-comparison-prd-box">
                                ...
                                <div class="rbt-comparison-prd-img">
                                    <a href="product-single-default.html">
                                        <img src="assets/images/product-img/electronics/electronics-bg-trans-07-a-1.webp"
                                            alt="Product Image">
                                    </a>
                                </div>
                                <h2 class="rbt-product-title h6">
                        ...
                        <div class="col-10 col-md-3 col-lg-3">
                            <div class="rbt-card rbt-comparison-prd-box">
                                ...
                                <div class="rbt-comparison-prd-img">
                                    <a href="product-single-default.html">
                                        <img src="assets/images/product-img/electronics/electronics-bg-trans-08-a-1.webp"
                                            alt="Product Image">
                                    </a>
                                </div>
                                <h2 class="rbt-product-title h6">
                ...
                <div class="col-12 col-lg-3 col-xl-2">
                    <div class="rbt-popup-action-area justify-content-center">
                        ...
                        <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn has-left-icon mb--12"
                            href="shop.html"><i class="fa-regular fa-browser"></i> Browse Products</a>
    ...
    <div class="rbt-quickview-sidenav-area">
        <!-- Start Component Area -->
        <div class="rbt-single-product-area rbt-bg-color-white rbt-content-trs-portion">
            <div class="row row--16 mt_dec--24">
                <div class="col-lg-12 col-12 mt--24">
                    <div class="rbt-single-nav">
                        <div class="rbt-products-nav justify-content-start">
                            <div class="tooltips" data-tooltip="Previous Product" data-tooltip-position="top">
                            ...
                            <a href="shop.html" class="rbt-product-nav-btn rbt-round-btn tooltips"
                                data-tooltip="Back To Products" data-tooltip-position="top">
                                <i class="fa-regular fa-grid-2"></i>
                            </a>

                            <div class="tooltips" data-tooltip="Next Product" data-tooltip-position="top">
                ...
                <div class="col-lg-12 col-12 mt--24 mt_sm--12">
                    <div class="rbt-product-view-slider rbt-single-product-media-area">
                        <div class="swiper rbt-arrow-between rbt-product-single-slider-activation rbt-arrow-show-dfl">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="thumbnail rbt-rounded--16">
                                ...
                                <div class="swiper-slide">
                                    <div class="thumbnail rbt-rounded--8">
                                        <div class="rbt-product-single-img">
                                            <img class="w-100"
                            ...
                            <div class="rbt-swiper-arrow rbt-modal-arrow-left">
                            ...
                            <div class="rbt-swiper-arrow rbt-modal-arrow-right">
                                <div class="custom-overflow">
                    ...
                    <div class="content mt--24">
                        <a href="#" class="rbt-card-subtitle rbt-card-catagories-text mt--0">Headphones</a>
                        <h2 class="rbt-card-title h6"><a href="#">G244F 23.8 inch FHD 4k Rapid IPS
                                170Hz
                                Super Vertical</a></h2>
                        <p class="description-text b2">
                            At vero eos et accusamus et iusto dignissimos ducimus blanditiis praesentium voluptatu
                            atque...
                        </p>
                        ...
                        <div class="rbt-info-wrapper d-flex mt--24">
                            <div class="prd-info-section">
                                <div class="prd-id-text">
                                    ...
                                    <a href="#" class="rbt-brand-img tooltips" data-tooltip="Product Brand"
                            ...
                            <div class="prd-info-section has-left-separator">
                                <div class="prd-id-text">
                                    ...
                                    <a href="#" class="rbt-brand-img tooltips" data-tooltip="All Europe Delivary"
                                        data-tooltip-position="top"><img
                        ...
                        <div class="rbt-info-wrapper d-flex mt--24 rbt-gap--12 flex-wrap">
                            <div class="prd-info-section">
                                <a class="rbt-quick-info-tag d-flex align-items-center rbt-gap--8 rbt-flash-animation"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#FCE202" />
                                        <defs>
                                            <linearGradient id="paint0_linear_3632_18878" x1="11.9995" y1="22.0148"
                                    ...
                                    <div class="rbt-color-select-area">
                                        <ul
                                            ...
                                            <li><a class="rbt-switcher--color tooltips rbt-switcher--color-one"
                                                    ...
                                                    data-tooltip="Black" data-tooltip-position="top" href="#">
                                                    <div class="rbt-color-circle"></div>
                                                </a></li>
                                            <li class="active"><a
                                                    ...
                                                    data-tooltip="Pink" data-tooltip-position="top" href="#">
                                                    <div class="rbt-color-circle"></div>
                                                </a></li>
                                            <li><a class="rbt-switcher--color tooltips rbt-switcher--color-three"
                                                    ...
                                                    data-tooltip="Dark" data-tooltip-position="top" href="#">
                                                    <div class="rbt-color-circle"></div>
                                                </a></li>
                                            <li><a class="rbt-switcher--color tooltips rbt-switcher--color-four"
                                                    ...
                                                    data-tooltip="White" data-tooltip-position="top" href="#">
                                                    <div class="rbt-color-circle"></div>
                                                </a></li>
                                            <li><a class="rbt-switcher--color tooltips rbt-switcher--color-five rbt-switcher--disable disabled"
                                                    data-switcher-color="#a09fa4"
                                                    data-src="assets/images/product-single/earphone/earphone-03.webp"
                                                    data-tooltip="Gray" data-tooltip-position="top" href="#">
                                                    <div class="rbt-color-circle"></div>
                                                </a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="rbt-info-wrapper d-flex mt--16">
                            <div class="prd-info-section">
                                <div class="rbt-product-switch-area flex-column align-items-start">
                                    <p class="text-bold title">Gift Item/Product :</p>
                                    <ul class="rbt-switcher-product-list product-switcher-activation">
                                        <li><a class="rbt-switcher--prd rbt-bg-color-brand-100 rbt-image-tooltip-activation rbt-switcher--prd-one"
                                                href="#">
                                                <img src="assets/images/product-single/ear-add-prd/eadd-prd-1.webp"
                                                    alt="Product Image">
                                                <div class="rbt-image-tooltip-box">
                                                    <img src="assets/images/product-single/ear-add-prd/eadd-prd-1.webp"
                                                        alt="Product Image">
                                                    <span class="img-desc-text">Go Pro</span>
                                                </div>
                                            </a></li>
                                        <li class="active"><a
                                                class="rbt-switcher--prd rbt-bg-color-brand-100 rbt-image-tooltip-activation rbt-switcher--prd-two"
                                                href="#">
                                                <img src="assets/images/product-single/ear-add-prd/eadd-prd-2.webp"
                                                    alt="Product Image">
                                                <div class="rbt-image-tooltip-box">
                                                    <img src="assets/images/product-single/ear-add-prd/eadd-prd-2.webp"
                                                        alt="Product Image">
                                                    <span class="img-desc-text">Watch</span>
                                                </div>
                                            </a></li>
                                        <li><a class="rbt-switcher--prd rbt-bg-color-brand-100 rbt-image-tooltip-activation rbt-switcher--prd-three"
                                                href="#">
                                                <img src="assets/images/product-single/ear-add-prd/eadd-prd-3.webp"
                                                    alt="Product Image">
                                                <div class="rbt-image-tooltip-box">
                                                    <img src="assets/images/product-single/ear-add-prd/eadd-prd-3.webp"
                                                        alt="Product Image">
                                                    <span class="img-desc-text">Camera</span>
                                                </div>
                                            </a></li>
                                        <li><a class="rbt-switcher--prd rbt-bg-color-brand-100 rbt-image-tooltip-activation rbt-switcher--prd-four"
                                                href="#">
                                                <img src="assets/images/product-single/ear-add-prd/eadd-prd-4.webp"
                                                    alt="Product Image">
                                                <div class="rbt-image-tooltip-box">
                                                    <img src="assets/images/product-single/ear-add-prd/eadd-prd-4.webp"
                                                        alt="Product Image">
                                                    <span class="img-desc-text">Airpod</span>
                                                </div>
                                            </a></li>
                                        <li><a class="rbt-switcher--prd rbt-bg-color-brand-100 rbt-image-tooltip-activation rbt-switcher--prd-four"
                                                href="#">
                        ...
                        <div class="rbt-info-wrapper d-flex mt--20">
                            <div class="product-styles-grp d-flex mt--0">
                                ...
                                <div class="content d-flex flex-wrap">
                                    ...
                                    <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn" href="#">Audio Port</a>
                                    <a class="rbt-btn rbt-btn-border rbt-btn-sm rbt-square-btn" href="#">Type C Jack</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-btn-grp">
                            ...
                            <a class="rbt-btn rbt-btn-border has-left-icon d-block text-center" href="#"
                    ...
                    <div class="rbt-comparison-popup-area rbt-bg-color-white rbt-content-trs-portion">
                        <div class="inner">
                            <div class="rbt-comparison-prd-box">
                                <div class="rbt-comparison-prd-img">
                                    <img src="assets/images/product-img/electronics/electronics-bg-trans-01.webp"
                                        alt="Product Image">
                                </div>
                            ...
                            <div class="rbt-popup-action-area text-center">
                                ...
                                <a class="rbt-btn rbt-btn-sm rbt-square-btn d-block has-left-icon mb--12" href="#"><i
                                        class="fa-regular fa-scale-balanced"></i> Compare Now</a>
                                                ...
                                                <div class="rbt-card rbt-product-card">
                                                    ...
                                                    <div class="rbt-card-body">
                                                        ...
                                                        <h3 class="rbt-card-title h6"><a
                                                                ...
                                                                Cordless 7 Speed With protect UV ray Hand Mixer
                                                                (Blue)</a>
                                                        </h3>
                                                        <div class="rbt-card-rating">
                                                            <ul class="rbt-rating-icon-list">
                                                    ...
                                                    <div class="rbt-scroll-vertical content">
                                                        ...
                                                        <div class="rbt-info-wrapper d-flex mt--16">
                                                            <div class="rbt-card-rating mt--0">
                                                                ...
                                                                <p class="rating-digit">(46)</p>
                                                                <div
                                                                    class="rbt-text-swiper-container rbt-arrow-vertical">
                                                                    <div class="swiper-wrapper">
                                                                        <div class="swiper-slide">
                                                        ...
                                                        <div
                                                            class="rbt-info-wrapper d-flex mt--16 rbt-gap--8 flex-wrap">
                                                            <div class="prd-info-section">
    ...
    <div class="rbt-default-modal has-rbt-top-folder-shape modal fade" id="popup-cartModal" tabindex="-1" role="dialog"
                                ...
                                <div class="rbt-minicart-bottom mt--24">
                                    ...
                                    <div class="share-btn-grp rbt-link-hover">
                                        <a href="cart.html" class="share-btn"><i class="fa-regular fa-pen mr--4"></i>
                                            ...
                                            Cart</a>
                                        <button data-bs-toggle="modal" data-bs-target="#socialShareModal" type="button"
                                            class="share-btn"><i class="fa-sharp fa-solid fa-link mr--4"></i> Share
                                            Cart</button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="rbt-default-modal modal fade has-rbt-top-folder-shape" id="notifyModal" tabindex="-1" role="dialog"
                        ...
                        <div class="rbt-notify-modal-content">
                            ...
                            <div class="rbt-info-wrapper d-flex mt--8 rbt-gap--12">
                                <div class="rbt-info-box rbt-notify-box w-100">
                                    ...
                                    <div class="rbt-input-field-grp">
                                        <input class="rbt-input-field rbt-bg-color-white shadow-none plr--24"
                                        ...
                                        <tr class="rbt-compare-prd-table-head">
                                            <td class="rbt-compare-table-title">
                                                <div class="rbt-compare-values">
                                                    ...
                                                    <p class="rbt-compare-table-text">Find and select products to see
                                                        the
                                                        differences
                                            ...
                                            <td>
                                                <div class="rbt-compare-item-wrapper">
                                                    ...
                                                    <a href="product-single-default.html"
                                                        ...
                                                        <img src="assets/images/compare-products/compare-prd-img-elc-1.webp"
                                                            alt="Product Image">
                                                    </a>
                                                    <div class="rbt-compare-values">
                                                        <a href="shop-by-categories.html"
                                                            class="rbt-product-item-category">
                                                            Apple AirPods
                                                        </a>
                                            ...
                                            <td>
                                                <div class="rbt-compare-item-wrapper">
                                                    ...
                                                    <a href="product-single-default.html"
                                                        ...
                                                        <img src="assets/images/compare-products/compare-prd-img-elc-2.webp"
                                                            alt="Product Image">
                                                    </a>
                                                    <div class="rbt-compare-values">
                                                        <a href="shop-by-categories.html"
                                                        ...
                                                        <p class="rbt-product-item-title h6">
                                                            <a href="product-single-default.html">Samsung Galaxy Buds 2
                                            ...
                                            <td>
                                                <div class="rbt-compare-item-wrapper">
                                                    ...
                                                    <a href="product-single-default.html"
                                                        ...
                                                        <img src="assets/images/compare-products/compare-prd-img-elc-3.webp"
                                                            alt="Product Image">
                                                    </a>
                                                    <div class="rbt-compare-values">
                                                        <a href="shop-by-categories.html"
                                            ...
                                            <td>
                                                <div class="rbt-compare-item-wrapper">
                                                    ...
                                                    <a href="product-single-default.html"
                                                        ...
                                                        <img src="assets/images/compare-products/compare-prd-img-elc-4.webp"
                                                            alt="Product Image">
                                                    </a>
                                                    <div class="rbt-compare-values">
                                                        <a href="shop-by-categories.html"
                                                        ...
                                                        <p class="rbt-product-item-title h6">
                                                            <a href="product-single-default.html">Apple AirPods Max
    ...
    <!-- End Quick View Modal Area  -->
    <!-- Start Coupon Collection Modal Area  -->
    <div class="rbt-default-modal modal fade has-rbt-top-folder-shape" id="couponCollectionModal" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog rbt-coupon-modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="rbt-folder-shape-right-portion">
                    <svg xmlns="http://www.w3.org/2000/svg" width="85" height="90" viewBox="0 0 85 90" fill="none">
                        <path
                ...
                <div class="rbt-top-folder-shape-wrapper">
                    <div class="rbt-coupon-wrapper rbt-gap--24 rbt-bg-color-white rbt-content-trs-portion">
                        <h4 class="mb--0 rbt-text-bold">Sign in to receive the coupons below</h4>
                        <div class="rbt-coupon">
                            <div class="inner rbt-text-copy-activation">
                                <div class="left-part">
                                    <input type="text" value="WELCOME100" readonly=""
                        ...
                        <div class="rbt-coupon">
                            <div class="inner rbt-text-copy-activation">
                                <div class="left-part">
                                    <input type="text" value="NEW2025" readonly=""
                                        class="rbt-coupon-code-text rbt-has-right-shepe-border rbt-copy-value-field">
                                </div>
                                <div class="coupon-details">
                                    <h2 class="rbt-coupon-info-title b1">UP TO 25% OFF</h2>
                                    <p class="rbt-coupon-info-sub-title b3 mt--4">For orders over $12.90</p>
                                    <ul class="rbt-coupon-info-list mt--12">
                                        <li><span>02/18/2025 14:00 ~ 03/25/2025 14:00</span></li>
                                        <li><span>The minimum spend for this coupon <strong>$200.00</strong></span></li>
                                    </ul>
                                </div>
                                <button class="copy-icon rbt-round-btn rbt-bg-primary rbt-copy-btn" data-tooltip="Copy">
                        ...
                        <a class="rbt-btn rbt-btn-sm d-block text-center mt--8" href="#">Collect All</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row row--12 mt_dec--24 align-items-center">
                <div class="col-lg-8 mt--24 justify-content-center justify-content-md-start d-flex">
                    <div class="rbt-newsletter-content-wrapper">
                        ...
                        <p class="sub-title">Subscribe and get discount 20% Off</p>
                    </div>
                </div>
                <div
                    class="col-lg-4 mt--24 d-flex justify-content-center justify-content-md-end text-center text-md-left d-flex">
                ...
                <div class="row justify-content-between row--12 mt_dec--24 pb--40 pb_sm--24">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--24 border-end rbt-border-color-border-2">
                        <div class="footer-widget">
                            ...
                            <p class="description pr--140 pr_sm--0">Worldwide electronics store since
                                1978. We sell over 1000+ branded products on our web-site.
                            </p>
                            <div class="rbt-quick-contact-info">
                                <p class="b2 title">Free from fixed and mobile phones.</p>
                                <a class="contact-link has-lg-fsize" href="tel:0800300353">0 800 300-353</a>
                            </div>
                            <div class="rbt-quick-contact-info">
                                <p class="b2 title">Call Center hours</p>
                                <p class="text-inf">Mon-Sun 09:00-19:00</p>
                            </div>
                            <div class="rbt-quick-contact-info d-flex rbt-gap--4 align-items-center">
                                <p class="b2 title mb--0">Email : </p>
                                <a class="contact-link" href="mailto:someone@example.com"> info@rbtshop.com</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 mt--24">
                        <div class="footer-widget rbt-link-hover">
                            ...
                            <ul class="ft-link">
                                ...
                                <li>
                                    <a href="return-policy.html">Returns & Replacements</a>
                                </li>
                                <li>
                                    <a href="my-order-history.html">Shipping Rates & Policies</a>
                                </li>
                                <li>
                                    <a href="return-policy.html">Refund and Returns Policy</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="account-notifications.html">Cookie Settings</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 mt--24">
                        <div class="footer-widget rbt-link-hover">
                            ...
                            <ul class="ft-link">
                                <li>
                                    <a href="shop.html">Sell on Unimart</a>
                                </li>
                                <li>
                                    <a href="shop.html">Sell Your Services on Unimart</a>
                                </li>
                                <li>
                                    <a href="shop.html">Sell on Unimart Business</a>
                                </li>
                                <li>
                                    <a href="shop.html">Sell Your Apps on Unimart</a>
                                </li>
                                <li>
                                    <a href="shop.html">Become an Affilate</a>
                                </li>
                                <li>
                                    <a href="shop.html">Advertise Your Products</a>
                                </li>
                                <li>
                                    <a href="shop.html">Sell-Publish with Us</a>
                                </li>
                                <li>
                                    <a href="shop.html">Become an Unimart Vendor</a>
                                </li>
                                <li>
                                    <a href="shop.html">Unimart Affiliation Program</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 mt--24">
                        <div class="footer-widget rbt-link-hover">
                            ...
                            <ul class="ft-link">
                                ...
                                <li>
                                    <a href="find-store.html">Store Locations</a>
                                </li>
                                <li>
                                    <a href="find-store.html">Unimart Near Me</a>
                                </li>
                                <li>
                                    <a href="about.html">Unimart Dealership</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row row--12 align-items-center mt_dec--24">
                    <div class="col-lg-6 mt--24">
                        <div class="rbt-footer-social-area justify-content-center justify-content-lg-start">
                            ...
                            <ul
                                class="social-icon social-icon-md rbt-social-default with-bg-primary justify-content-start justify-content-lg-end">
                                <li><a href="#"><i class="fa-brands fa-x-twitter"></i></a></li>
                                <li><a href="#"><i class="fa-brands fa-youtube"></i></a></li>
                    ...
                    <div class="col-lg-6 mt--20">
                        <div class="rbt-app-store-area justify-content-center justify-content-lg-end">
                            ...
                            <ul class="rbt-app-store-list">
                                <li><a href="#"><img src="assets/images/footer/apple-store-logo.webp"
                                            alt="App Store"></a>
                                </li>
                                <li><a href="#"><img src="assets/images/footer/play-store-logo.webp"
                                            alt="App Store"></a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row row--12 align-items-center justify-content-between mt_dec--24">
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-12 col-12 mt--24">
                    <p class="rbt-link-hover text-center text-lg-start">Copyright <span
                            class="copyright-year">2025</span>
                        &copy;
                        <a href="https://rainbowthemes.net/"
                            class="rbt-text-semi-bold rbt-text-color-heading">Unimart</a>
                        HTML Template.
                    </p>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-12 col-12 mt--24">
                    <ul class="payment-img-link">
                        <li><a href="#"><img src="assets/images/payment-brand/image-01.webp"
                                    alt="Payment Brand Image"></a>
                        </li>
                    </ul>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-12 col-md-12 col-12 mt--24">
                    <ul
                        class="copyright-link rbt-link-hover justify-content-center justify-content-xl-end mt_sm--12 mt_md--12 mt_lg--12">
    ...
    <div class="rbt-default-modal modal fade has-rbt-top-folder-shape" id="signinModal" tabindex="-1" role="dialog"
                    ...
                    <div class="rbt-login-form rbt-bg-color-white rbt-content-trs-portion">
                        <div class="rbt-login-form-inner">
                            <div class="rbt-login-form-top">
                                ...
                                <h3 class="rbt-title rbt-text-bold mb--16 h6" id="signinModalLabel">Sign In To Proceed
                                </h3>
                                <div class="rbt-tab rbt-round-shape-tab">
                                    ...
                                    <ul class="nav nav-tabs" id="registerFormTab1" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="rbt-form-tab-id-1" data-bs-toggle="tab"
                                                data-bs-target="#rbt-form-tab-pane-1" type="button" role="tab"
                                                aria-controls="rbt-form-tab-pane-1" aria-selected="true">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="rbt-form-tab-id-2" data-bs-toggle="tab"
                                                data-bs-target="#rbt-form-tab-pane-2" type="button" role="tab"
                                                aria-controls="rbt-form-tab-pane-2" aria-selected="false">
                                    ...
                                    <form>
                                        ...
                                        <div class="tab-content" id="registerFormTab1Content">
                                            <div class="tab-pane fade show active" id="rbt-form-tab-pane-1"
                                                role="tabpanel" aria-labelledby="rbt-form-tab-id-1" tabindex="0">
                                                <div class="rbt-input-field-grp">
                                                    <label class="rbt-field-label" for="modal_signin_number">Your
                                                        Number<span class="rbt-text-color-danger">*</span></label>
                                                    <input class="rbt-input-field" placeholder="Number" type="text"
                                            ...
                                            <div class="tab-pane fade" id="rbt-form-tab-pane-2" role="tabpanel"
                                                ...
                                                <div class="rbt-input-field-grp">
                                                    ...
                                                    <input class="rbt-input-field" placeholder="Email" type="email"
                                ...
                                <button type="submit"
                                    ...
                                    <img class="icon" src="assets/images/icons/fb-icon.webp" alt="Icon">
                                    Continue with Facebook
                                </button>
                                <button type="submit"
                                    class="rbt-btn rbt-btn-border rbt-social-login-btn d-block w-100 rbt-social-login-btn">
                                    <img class="icon" src="assets/images/icons/google-icon.webp" alt="Icon">
                                ...
                                <div class="rbt-login-system-switch rbt-link-hover">
                                    ...
                                    <button class="rbt-switch-btn" data-bs-toggle="modal" data-bs-target="#signupModal"
                                        data-bs-dismiss="modal" aria-label="Close"><span>Create an
                                            account</span></button>
                                </div>
                            </div>
    ...
    <!-- Start Sign In Modal Area  -->
    <div class="rbt-default-modal has-rbt-top-folder-shape modal fade" id="signupModal" tabindex="-1" role="dialog"
                    ...
                    <div class="rbt-login-form rbt-bg-color-white rbt-content-trs-portion">
                        <div class="rbt-login-form-inner">
                            <div class="rbt-login-form-top">
                                ...
                                <h3 class="rbt-title rbt-text-bold mb--16 h6" id="signupModalLabel">Create an Account
                                </h3>
                                ...
                                <div class="rbt-tab rbt-round-shape-tab">
                                    ...
                                    <ul class="nav nav-tabs" id="modal_signinTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="rbt-form-tab-id-3" data-bs-toggle="tab"
                                                data-bs-target="#rbt-form-tab-pane-3" type="button" role="tab"
                                                aria-controls="rbt-form-tab-pane-3" aria-selected="true">
                                                <i class="fa-sharp fa-regular fa-phone"></i>
                                                Phone Number
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="rbt-form-tab-id-4" data-bs-toggle="tab"
                                                data-bs-target="#rbt-form-tab-pane-4" type="button" role="tab"
                                                aria-controls="rbt-form-tab-pane-4" aria-selected="false">
                                                <i class="fa-sharp fa-regular fa-envelope"></i>
                                                Email
                                            </button>
                                        </li>
                                    ...
                                    <form>
                                        <div class="tab-content" id="modal_signinTabContent">
                                            <div class="tab-pane fade show active" id="rbt-form-tab-pane-3"
                                                role="tabpanel" aria-labelledby="rbt-form-tab-id-3" tabindex="0">
                                                <div class="rbt-input-field-grp">
                                ...
                                <div class="rbt-login-system-switch rbt-link-hover">
                                    Already a customer?
                                    <button class="rbt-switch-btn" data-bs-toggle="modal" data-bs-target="#signinModal"
                                        data-bs-dismiss="modal" aria-label="Close"><span>Sign In</span></button>
                                </div>
                            </div>
                                            ...
                                            <div class="grid-5-meso">
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-electronics.html">Electronics - 1</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition electronics">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-printing-service.html">Print Service
                                                                        -
                                                                        1</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition cosmetics fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cosmetic-beauty.html">Cosmetic Beauty
                                                                        -
                                                                        1</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition glass">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-accessories.html">Accessories - 1</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-furniture-two.html">Furniture - 2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-jewellery-two.html">Jewellery - 2</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="home-cosmetic-beauty-four.html"><img
                                                                        src="assets/images/splash/demo-pages/demo-cosmetics-04.webp"
                                                                        alt="Demo Images"></a>
                                                            </div>
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-cosmetic-beauty-four.html">Cosmetics
                                                                        Beauty 4</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-paddle-boards.html">Paddle Boards</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hoodie-stores-one.html">Hoodie Store
                                                                        -
                                                                        1</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition fashion">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-hoodie-stores-two.html">Hoodie Store
                                                                        -
                                                                        2</a></h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="rbt-meso-item transition phone">
                                                    <div
                                                        ...
                                                        <div class="inner">
                                                            ...
                                                            <div class="content">
                                                                <h3 class="rbt-title"><a
                                                                        href="home-black-friday-sale.html">Black Friday
                                                                        Sale</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="row row row--0">
                <div class="col-md-12">
                    <ul class="rbt-quick-access onepagenav">
                        <li class="rbt-access-box">
                            <a href="shop.html" class="rbt-round-btn has-rbt-md-fsize">
                                <i class="fa-regular fa-bag-shopping"></i>
