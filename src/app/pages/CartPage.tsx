...
export const CartPage = () => {
  ...
  const hasCargoItems = cart.some(item => item.product.type === 'preorder' && item.product.weightKg && !item.product.cargoIncludedInPrice && cargoRate > 0);
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="text-right">
                      ...
                      {item.product.type === 'preorder' && item.product.weightKg && !item.product.cargoIncludedInPrice && cargoRate > 0 && (
