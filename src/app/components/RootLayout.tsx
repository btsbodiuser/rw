  ...
  return (
    <AppProvider>
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <Header />
        <PWAInstallPrompt siteNameMn={s('site_name_mn', s('site_name', 'Guzeelzgene'))} siteLogo={settingsData?.['site_favicon'] ? `${import.meta.env.BASE_URL}backend/uploads/media/${settingsData['site_favicon']}` : undefined} />
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="font-bold text-xl mb-4">{s('site_name', 'Guzeelzgene')}</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li>И-мэйл: {s('email', 'info@guzeelzgeneshop.mn')}</li>
                  <li>
            ...
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
              © {new Date().getFullYear()} {s('site_name', 'Guzeelzgene')} {s('site_slogan', 'Дэлгүүр')}. Бүх эрх хуулиар хамгаалагдсан.
            </div>
          </div>
        </footer>
        <GoToTopButton />
