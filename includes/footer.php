...
?>
    ...
    <?php if (sBool('newsletter_modal_enabled', false)): ?>
                    ...
                    <div class="rbt-welcome-banner-area rbt-content-trs-portion">
                        <div class="rbt-welcome-banner-content">
                            ...
                            <div class="rbt-welcome-banner-bottom pt--32">
                                <h2 class="text-center mb--12"><?= h(s('newsletter_modal_title', 'Онцгой саналыг бүү алдаарай')) ?></h2>
                                <p class="text-center b1 mb--32"><?= h(s('newsletter_modal_subtitle', 'Шинэ бараа, хямдрал, урамшууллын мэдээг хамгийн эхэнд авах боломж.')) ?></p>
                                <form id="rbtSubscribe-form" class="form-newsletter rw-newsletter-form" data-newsletter-form="modal" novalidate>
                                    <div class="rbt-input-field-grp">
                                        <input class="rbt-input-field" type="email" name="email" required placeholder="<?= h(s('newsletter_modal_placeholder', 'И-мэйл хаягаа оруулна уу')) ?>">
                                    </div>
                                    <div class="rw-newsletter-status" data-newsletter-status="modal"></div>
                                    <button type="submit" class="rbt-btn d-block w-100 mt--24 mb--16 radius-round-6">
                                        <?= h(s('newsletter_modal_btn', 'Мэдээллийн санд нэгдэх')) ?>
                                    </button>
                                </form>
                                <div class="text-center">
                                    <a href="#" data-bs-dismiss="modal"
                                        class="rbt-btn rbt-btn-naked radius-round-6 d-block"><?= h(s('newsletter_modal_skip', 'Одоохондоо сонирхохгүй байна')) ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="rbt-newsletter-area style--one pb--56 pb_sm--40">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6 col-xl-5 mt_sm--12 justify-content-start d-flex">
                            <div class="w-100">
                                <label class="h5 rbt-text-color-gray-200 mb--12"><?= h(s('newsletter_footer_label', 'Мэдээллийн санд бүртгүүлээрэй')) ?></label>
    ...
    <!-- End Footer aera -->    <!-- Start Sign In Modal Area  -->
