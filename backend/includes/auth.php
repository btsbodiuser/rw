...
$rolePages = [
    ...
    'admin' => ['dashboard', 'pos', 'products', 'product-form', 'product-delete', 'categories', 'category-form', 'category-delete', 'shops', 'shop-form', 'shop-delete', 'media', 'media-upload', 'media-delete', 'orders', 'order-detail', 'order-create', 'customers', 'customer-detail', 'customer-form', 'pos-history', 'cargo-batches', 'cargo-batch-form', 'batch-handout', 'inventory-arrivals', 'inventory-arrival-form', 'sms-queue', 'sms-templates', 'districts', 'district-form', 'reports', 'reconciliation', 'drivers', 'driver-form', 'driver-delete', 'deliveries', 'delivery-assign', 'product-entry-users', 'sync-products', 'stock-history', 'faqs', 'faq-form', 'faq-delete', 'activity-types', 'activity-type-form', 'activity-type-delete', 'contact-messages', 'newsletter-subscribers', 'features', 'feature-form', 'feature-delete'],
