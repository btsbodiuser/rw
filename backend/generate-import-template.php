...
// Row layout (25 columns):
//   0..14  product-level fields incl. preorder_date
//   15..19 attribute columns: gender, shoe_type, run_type, cushioning, gait
//   20..24 variant columns: variant_color, variant_size, variant_sku, variant_price, variant_stock
$rows = [
    $headers,
    ...
    ['WH-003','Sneakers Air','Гутал Эйр','Sport','Спорт','ready',180000,220000,0.900,'WH-0003','',1,0,'open','',
        'men','road,lightweight','daily-run,tempo-run','responsive','neutral',
